...
{"name":"DE_WASDMovement","status":false,"description":"v1.1 Allows player movement via WASD keys and activation via E key in addition to standard arrow keys and Enter/Space for activation. No lag issues.","parameters":{}}
];
